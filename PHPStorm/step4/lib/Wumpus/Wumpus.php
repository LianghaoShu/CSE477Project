...
class Wumpus
{
    ...
    /**
     * Get status of carried
     * @return status of carried
     */
    ...
    /**
     * Get number of remain arrows
     * @return number of remain arrows
     */
     ...
     * @return int Constant: HAPPY, EATEN, or FELL
     */
    ...
    private function moveActual($ndx){
        ...
        if ($this->current->contains(self::PIT)){
            return self::FELL;
        }

        if ($this->current->contains(self::BIRDS)){
            $this->carried = true;
    ...
    /**
     * If get Wumpus' aroma
     * @return bool the existence of wumpus
     */
    ...
    /**
     * If there is a pit around
     * @return bool the existence of pit
     */
    ...
    /**
     * if there is a bird around
     * @return bool the existence of bird
     */
