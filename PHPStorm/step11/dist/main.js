...
const Login = function(sel) {
    var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
            ...
            success: function(data) {
                ...
                if(json.ok) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel + " .message").html("<p>" + json.message + "</p>");
                }
            },
            error: function(xhr, status, error) {
                // An error!
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel + " .message").html("<p>Error: " + error + "</p>");
            }
        });
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _parse_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parse_json */ "./src/parse_json.js");
/* harmony import */ var _Stars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Stars */ "./src/Stars.js");



const MovieInfo = function(sel) {
    var that = this;
    this.selected = '#information';
    this.obj = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel);
        ...
        success: function(data) {
            ...
            if(json.total_results === 0){
               that.obj.html("<p>No information available</p>");
                ...
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("ul > li > a").click(function(event) {
                    event.preventDefault();
...
const Stars = function(sel) {
    this.select = sel;
    this.table = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel + " table");  // The table tag
    // Loop over the table rows
    var rows = this.table.find("tr");    // All of the table rows
    for(var r=1; r<rows.length; r++) {
        // Get a row
        var row = jquery__WEBPACK_IMPORTED_MODULE_0___default()(rows.get(r));
        ...
        for(var s=0; s<stars.length; s++) {
            var star = jquery__WEBPACK_IMPORTED_MODULE_0___default()(stars.get(s));
...
Stars.prototype.message = function(message) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.select + ' .message').html(message).show().delay(2000).fadeOut(1000);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _noir_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_noir.scss */ "./src/_noir.scss");
/* harmony import */ var _noir_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_noir_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Login */ "./src/Login.js");
/* harmony import */ var _Stars__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Stars */ "./src/Stars.js");
/* harmony import */ var _MovieInfo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./MovieInfo */ "./src/MovieInfo.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
    new _Login__WEBPACK_IMPORTED_MODULE_2__["Login"]("#login");
    new _Stars__WEBPACK_IMPORTED_MODULE_3__["Stars"]('#stars');
    new _MovieInfo__WEBPACK_IMPORTED_MODULE_4__["MovieInfo"]("#info");
});
