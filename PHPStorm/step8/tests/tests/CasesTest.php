...
SQL;
    ...
    public function test_update(){
        //('id','client','agent','number','summary','status')
       // ("22", "9","Simpson, Bart", "8","Owen, Charle", "16-9876", "case summary", "O"),
        $row = array(
            'id'=>22,
            'agent'=>'11',
            'number'=>'16-9876',
        ...
        $this->assertTrue($cases->update($row));

        $this->assertFalse($cases->update($row1));
    ...
    public function test_delete(){
        $cases = new \Felis\Cases(self::$site);
        $this->assertFalse($cases->delete(26));
        $this->assertTrue($cases->delete(25));
    }
